...
NOTE: Since release 2.03, the Swiss Ephemeris is multithreading enabled. The way to achieve this was to simply declare all global and stativ variables as thread-local (storage class TLS). This git repo therefore is here only for historical reasons.
